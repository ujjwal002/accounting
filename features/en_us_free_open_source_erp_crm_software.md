# Accounting Open-Source ERP & CRM Software

GitHub: [https://github.com/Accounting/Accounting-erp-crm](https://github.com/Accounting/Accounting-erp-crm)
Demo: [https://barbarik.ai/open-source-erp-crm/](https://barbarik.ai/open-source-erp-crm/)
Website: [https://barbarik.ai](https://barbarik.ai)

## Sofware Stack

Accounting is a free open-source ERP & CRM app based on the "mern-stack". It utilizes the following technologies: Node.js, React.js, Redux, Express.js, MongoDB, and AntDesign (AntD).
